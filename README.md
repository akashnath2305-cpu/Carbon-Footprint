...
npm install
Configure your environment variables. Create a .env file in the backend directory (a sample is typically provided or you can structure it based on required keys like JWT_SECRET, database credentials, and GEMINI_API_KEY).
